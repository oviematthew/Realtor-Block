...
export default function FileUpload({ setImages, imageList, setImageList, listingId }) {
  ...
  async function removeUploaded(index) {
      ...
      <div className="preview grid grid-cols-3 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-7 xl:grid-cols-10 gap-3 mt-4">
        {imagePreview.map((image, index) => (
          <div key={index} className="relative">
            ...
            >
              <X className="hover:cursor-pointer" size={16} />
            </button>
          </div>
        ))}
